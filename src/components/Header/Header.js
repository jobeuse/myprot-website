                        ...
                        <div class="col-lg-12 p-3" id="header01">
                            <div class="d-flex flex-row">
                                <div class="flex-fill Logo">
                                    <h4> <span class="span1">R</span><span class="span2">Y</span> </h4> 
                                </div>
                                <div>
                                    <div class="d-flex p-5 pl-0 pt-0 pb-0 gap-3">
                                        <div class="flex-fill">
                                ...
                                <div class="col-lg-6 mt-5 p-5">
                                    <div class="row mt-5">
                                        ...
                                        <div class="col-lg-12 " id="header03">
                                            <div class="d-flex ">
                                                <div class="flex-fill">
                                                    <a class="mylink rounded btn" target="__blank" href="https://docs.google.com/document/d/1bdT9rovpozXALigFuT3Kr6ZlgkPDTywPiIDNY3R_Na8/edit?usp=sharing">View my CV</a>
                                                </div>
                                                <div class="flex-fill">
                                                    <a class="mylink2 rounded btn" href="https://wa.me/250780809031" target="__blank">Send me message</a>
                                                </div>
                                            </div>
